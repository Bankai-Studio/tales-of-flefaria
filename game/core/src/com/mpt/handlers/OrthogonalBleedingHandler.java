...
// Custom implementation of the Orthogonal renderer to fix tile bleeding;

public class OrthogonalBleedingHandler extends OrthogonalTiledMapRenderer {
    public OrthogonalBleedingHandler(TiledMap map) {
        super(map);
    }

    public OrthogonalBleedingHandler(TiledMap map, Batch batch) {
        super(map, batch);
    }

    public OrthogonalBleedingHandler(TiledMap map, float unitScale) {
        super(map, unitScale);
    }

    public OrthogonalBleedingHandler(TiledMap map, float unitScale, Batch batch) {
    ...
    // Method made by the LibGDX community to fix tile bleeding, implemented to the Orthogonal renderer;

    public static void removeBleeding(TextureRegion region) {
        float fix = 0.01f;
